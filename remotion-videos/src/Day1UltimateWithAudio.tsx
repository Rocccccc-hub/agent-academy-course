...
/**
 * Day 1 Ultimate With Audio - 带配音版本
 *
 * 使用前需要先生成音频文件：
...
export const Day1UltimateWithAudio: React.FC = () => {
  const fps = 30;
...
export default Day1UltimateWithAudio;
