      ...
      >
        <FloatingElement delay={0}>
          <AppleText delay={0} size={72} weight={800}>
            <span style={{ color: "#30cfd0" }}>Day 6</span>
          </AppleText>
        </FloatingElement>
        ...
        <div style={{ transform: `scale(${iconScale})` }}>
          <div
            style={{
              fontSize: "200px",
              filter: "drop-shadow(0 20px 60px rgba(48, 207, 208, 0.3))",
            }}
          >
            💻
          </div>
        ...
        <FloatingElement delay={30} floatIntensity={15}>
          <AppleText delay={30} size={96} weight={800}>
            <span style={{ color: "#1a1a1a" }}>实战项目开发</span>
          </AppleText>
        </FloatingElement>
